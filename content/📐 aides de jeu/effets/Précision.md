...
subtype: effet
---
> desc:: Lorsque l’arme est utilisée, son utilisateur **ajoute sa caractéristique Tir** (+ 1 point de dégâts par overdrive) (ou Machine divisé par 2, arrondi à l’entier supérieur, pour un PNJ) lorsqu’il détermine les **dégâts**.
