...
subtype: effet
---
> desc:: Lorsqu’un jet pour toucher est effectué avec cette arme, chaque réussite excédentaire **au-dessus** du score de **réaction** (dans le cas d’un tir) ou de **défense** (dans le cas d’une attaque au contact) de la cible permet de lui infliger **1 point de dégât** (ou de violence dans le cas d’une bande) supplémentaire.
